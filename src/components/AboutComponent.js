...
//Experimenting with styling....I know it's kinda ugly when stacked.
function RenderPartnerStacked({partner}) {
    if (partner) {
        return (
            <React.Fragment>
...
// preformatting {partner} with the above const partner before displaying. pppppppppppppppppppppp 
